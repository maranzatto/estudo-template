...
<template>
    <div class="card text-center max-w-md mx-auto">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Contador: {{ count }}</h2>
        ...
        <div class="flex justify-center gap-3 flex-wrap">
            <button @click="decrement" class="btn bg-red-500 hover:bg-red-600 text-white">-</button>
